...
from cs_qualif_step2.core.api.handler.unsupported_value_exception_handler import unsupported_value_exception_handler
...
def main():
    ...
    app.add_exception_handler(UnsupportedValueException, unsupported_value_exception_handler)
